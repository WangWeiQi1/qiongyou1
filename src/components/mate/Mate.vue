<template>
  <div class="container">
    ...
    <div class="title">结伴旅行</div>
    <ul class="footer">
      <li @click='routerLink("/Every")'>男女不限</li>
      <li @click='routerLink("/Men")'>男生专区</li>
      <li @click='routerLink("/Women")'>女生专区</li>
    </ul>
    <div class="delete">
      <div class="slider">
        <div class="content"
...
.text{
  ...
  .content .img{
    ...
    border-radius: 50%;
    overflow: hidden;
    background-image: url("../../../static/img/timg-5.jpeg");
    margin-left: .5rem;
    margin-top: .3rem;
  }
span{
